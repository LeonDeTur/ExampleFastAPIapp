...
class MyFirstDto(BaseModel):
    ...
    first_field: str | None = Field(
        description="Field for first argument", default=None, examples=["field_one"]
    )
    second_field: int = Field(
        ge=1, description="Int parameter", default=2, examples=[1, 2, 3]
    )
...
class SecondDto(MyFirstDto):
    ...
    scenario_info: str = Field(
        description="Scenario description", default="Scenario description"
    )
